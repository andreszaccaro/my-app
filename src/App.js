...
import logoNav from "./img/Icon-Nav.png";
import headerImg from "./img/Img_Header.png";
  ...
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="flex flex-col items-center mx-auto max-w-2xl py-20 sm:py-48 lg:py-56">
